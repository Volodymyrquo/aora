...
Discover Endless Possibilities with{' '}<Text className="text-secondary-200">Aora</Text>
    ...
    <Image source={images.path} className="w-[136px h-[15px] absolute -bottom-2 -right-16" resizeMode='contain' />
  </View>
<Text
className='text-sm font-pregular text-gray-100 mt-10 text-center'
